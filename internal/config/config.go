...
type WireOptions struct {
	...
	MCP        WireMCPOptions `json:"mcp,omitempty" jsonschema:"description=MCP wire logging options"`
}

type WireMCPOptions struct {
	Enabled  bool   `json:"enabled,omitempty" jsonschema:"description=Enable MCP wire logging,default=false"`
	LogMode  string `json:"log_mode,omitempty" jsonschema:"description=Logging mode for MCP wire logs: single or per_server,enum=single,enum=per_server,default=single"`
	Filename string `json:"filename,omitempty" jsonschema:"description=Filename for MCP wire log in single mode,default=mcp-wire.log"`
}
